...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/apple/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Apple 登录凭证",
                        "name": "credentials",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.AppleLoginInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "邮箱或密码无效，或该账户需通过 Apple 登录",
                        "schema": {
                            "$ref": "#/definitions/core.ApiResponse"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.SetPasswordInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/group.JoinGroupInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/groups/{uuid}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "要更新的圈子信息",
                        "name": "group",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/group.UpdateGroupInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "圈子信息更新成功",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/core.ApiResponse"
        ...
        "/media/{uuid}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "错误信息：'Media not found or permission denied'",
                        "schema": {
                            "$ref": "#/definitions/core.ApiResponse"
                        }
                    },
    ...
    "definitions": {
        "auth.AppleLoginInput": {
            ...
            "properties": {
                "fullName": {
                    "description": "首次授权时客户端传递，可能为 null",
                    "type": "object",
                    "properties": {
                        "familyName": {
                            "type": "string"
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "created_at": {
                    "description": "修改: 暴露 created_at",
                    "type": "string"
                },
                "email": {
                    "description": "Email 是关键锚点，始终唯一且必须存在",
                    "type": "string"
                },
                "id": {
                    "type": "integer"
                ...
                "username": {
                    "description": "关键修改: Username 和 Password 变为可选",
                    "type": "string"
                }
            }
        }
