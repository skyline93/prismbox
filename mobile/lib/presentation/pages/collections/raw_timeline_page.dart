// lib/presentation/pages/collections/raw_timeline_page.dart
...
/// RAW 时间线页面
///
/// 只显示 RAW 照片，支持本地/远程切换
@RoutePage()
class RawTimelinePage extends ConsumerStatefulWidget {
  const RawTimelinePage({super.key});

  @override
  ConsumerState<RawTimelinePage> createState() => _RawTimelinePageState();
}

class _RawTimelinePageState extends ConsumerState<RawTimelinePage>
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  if (isSelectionActive)
                    const TimelineSelectionAppBar(pageId: 'raw')
                  else
