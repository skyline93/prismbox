// lib/presentation/pages/collections/live_timeline_page.dart
...
/// Live Photo 时间线页面
///
/// 只显示 Live Photo，支持本地/远程切换
@RoutePage()
class LiveTimelinePage extends ConsumerStatefulWidget {
  const LiveTimelinePage({super.key});

  @override
  ConsumerState<LiveTimelinePage> createState() => _LiveTimelinePageState();
}

class _LiveTimelinePageState extends ConsumerState<LiveTimelinePage>
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  if (isSelectionActive)
                    const TimelineSelectionAppBar(pageId: 'live')
                  else
